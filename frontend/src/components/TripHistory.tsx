      ...
      <CardContent>
        <div className="space-y-4">
          {tripHistory.map((trip) => (
            <Card key={trip.id} className="glass-card border-card-border hover:border-primary/20 transition-colors">
                  ...
                  <div className="flex-1 space-y-2">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                      ...
                      <div className="flex items-center space-x-2">
                        ...
                        <span className="font-medium">{trip.averageSpeed.toFixed(0)} km/h</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="space-y-2 text-sm">
                        ...
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Duration:</span>
                          <span className="font-medium">{formatDuration(selectedTrip.duration)}</span>
                        </div>
                        <div className="flex justify-between">
                          <span className="text-muted-foreground">Average Speed:</span>
                          <span className="font-medium">{selectedTrip.averageSpeed.toFixed(1)} km/h</span>
                        </div>
                        <div className="flex justify-between">
